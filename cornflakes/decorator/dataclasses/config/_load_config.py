...
def create_file_loader(  # noqa: C901
    ...
    def _check_any_key_in_fields(config_dict) -> dict:
        return {
            section: config
            for section, config in config_dict.items()
    ...
    def _check_config_dict(config_dict) -> dict:
    ...
    def _rename_default_section(config_dict) -> dict:
    ...
    def from_file(
        ...
        filter_function: Optional[Callable[[Type[Config]], bool]] = None,
