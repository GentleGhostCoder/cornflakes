...
void nth_combination_example01() {
  ...
  const std::size_t combination_count =
      static_cast<std::size_t>(strtk::n_choose_k(n, k));
  ...
  for (std::size_t i = 0; i < combination_count; ++i) {
    ...
    strtk::nth_combination_sequence(i, k, char_list.begin(), char_list.end(),
...
void nth_combination_example02() {
  ...
  for (std::size_t i = 0; i < combination_count; ++i) {
    ...
    strtk::next_combination(next_comb_list.begin(), next_comb_list.begin() + k,
                            next_comb_list.end());
  }
...
void nth_combination_example03() {
  ...
  list_type nth_combination;
  strtk::nth_combination_sequence(4, k, char_list.begin(), char_list.end(),
                                  std::back_inserter(nth_combination));
